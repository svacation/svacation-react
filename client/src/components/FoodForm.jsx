	...
	shoppingListString
		...
		<Card className="container">
			...
			<form action="/" onSubmit={onSubmit} name="shoppingForm">
				<Button bsSize="lg" onClick={toggle} name="shoppingButton" style={{
					margin: "auto", width: "50%",
					display: "block"
				}}>
					购买食材
				...
				<Panel collapsible expanded={shoppingOpen}>
					...
					<FormGroup controlId="formControlsSelect" >
						...
						<FormControl componentClass="select" placeholder="select" name="item" onChange={onChange} style={{
							margin: "auto", width: "50%",
							display: "block"
						}}>
							<option></option>
					...
					<FormGroup controlId="formControlsSelect" >
						...
						<FormControl componentClass="select" placeholder="select" name="numberOfItem" onChange={onChange} style={{ width: 30 }} style={{
							margin: "auto", width: "50%",
							display: "block"
						}}>
							<option></option>
